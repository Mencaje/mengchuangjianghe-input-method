...
def main():
    ...
    print("本皮肤「%s」构建完成。请回到「萌创匠盒输入法」根目录双击 build_static.py 以被远程检测。" % SKIN_ID)
    return 0
